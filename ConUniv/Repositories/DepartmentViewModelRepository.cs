...
namespace ConUniv.Repositories
{
    ...
    public class DepartmentViewModelRepository : IDisposable, IDataSource<DepartmentViewModel, Guid> 
    {
        DBTableDataSourceBase<DepartmentViewModel, Guid> dataSource;
        ...
        public DepartmentViewModelRepository()
        {
            this.TableName = typeof(DepartmentViewModel).Name;
            this.ConnectionString = "Default";
            InitializeDataSource();
        }

        public DepartmentViewModelRepository(string connectionString)
        {
            this.TableName = typeof(DepartmentViewModel).Name;
        ...
        public DepartmentViewModelRepository(string connectionString,string tableName)
        {
            this.ConnectionString = connectionString;
        ...
        {
            dataSource = new DBTableDataSourceBase<DepartmentViewModel, Guid>(this.ConnectionString, this.TableName);
        }
        ...
        public bool DeleteEntity(DepartmentViewModel item)
        {
        ...
        public IEnumerable<DepartmentViewModel> GetAll(object orderBy)
        {
            return this.dataSource.GetAll(orderBy: orderBy);
        }

        public IEnumerable<DepartmentViewModel> GetMany(string select, string where, string orderBy)
        {
            return this.dataSource.GetMany(select: select, where: where, orderBy: orderBy);
        }

        public IEnumerable<DepartmentViewModel> GetMany(object where)
        {
            return this.dataSource.GetMany(where: where);
        }

        public IEnumerable<DepartmentViewModel> GetMany(object where, object orderBy)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy);
        }

        public IEnumerable<DepartmentViewModel> GetMany(object where, Needletail.DataAccess.Engines.FilterType filterType, object orderBy, int? topN)
        {
            return this.dataSource.GetMany(where: where, filterType: filterType, orderBy: orderBy, topN: topN);
        }

        public IEnumerable<DepartmentViewModel> GetMany(object where, object orderBy, Needletail.DataAccess.Engines.FilterType filterType, int page, int pageSize)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy, filterType: filterType, page: page, pageSize: pageSize);
        }

        public IEnumerable<DepartmentViewModel> GetMany(string where, string orderBy, Dictionary<string, object> args, int page, int pageSize)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy, args: args, page: page, pageSize: pageSize);
        }

        public IEnumerable<DepartmentViewModel> GetMany(string where, string orderBy, Dictionary<string, object> args, int? topN)
        {
        ...
        public DepartmentViewModel GetSingle(object where)
        {
            return this.dataSource.GetSingle(where: where);
        }

        public DepartmentViewModel GetSingle(object where, Needletail.DataAccess.Engines.FilterType filterType)
        {
            return this.dataSource.GetSingle(where: where, filterType: filterType);
        }

        public DepartmentViewModel GetSingle(string where, Dictionary<string, object> args)
        {
            return this.dataSource.GetSingle(where: where, args: args);
        }

        public Guid Insert(DepartmentViewModel newItem)
        {
