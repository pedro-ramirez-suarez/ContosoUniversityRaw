...
namespace ConUniv.Repositories
{
    ...
    public class CourseViewModelRepository : IDisposable, IDataSource<CourseViewModel, Guid> 
    {
        DBTableDataSourceBase<CourseViewModel, Guid> dataSource;
        ...
        public CourseViewModelRepository()
        {
            this.TableName = typeof(CourseViewModel).Name;
            this.ConnectionString = "Default";
            InitializeDataSource();
        }

        public CourseViewModelRepository(string connectionString)
        {
            this.TableName = typeof(CourseViewModel).Name;
        ...
        public CourseViewModelRepository(string connectionString,string tableName)
        {
            this.ConnectionString = connectionString;
        ...
        {
            dataSource = new DBTableDataSourceBase<CourseViewModel, Guid>(this.ConnectionString, this.TableName);
        }
        ...
        public bool DeleteEntity(CourseViewModel item)
        {
        ...
        public IEnumerable<CourseViewModel> GetAll(object orderBy)
        {
            return this.dataSource.GetAll(orderBy: orderBy);
        }

        public IEnumerable<CourseViewModel> GetMany(string select, string where, string orderBy)
        {
            return this.dataSource.GetMany(select: select, where: where, orderBy: orderBy);
        }

        public IEnumerable<CourseViewModel> GetMany(object where)
        {
            return this.dataSource.GetMany(where: where);
        }

        public IEnumerable<CourseViewModel> GetMany(object where, object orderBy)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy);
        }

        public IEnumerable<CourseViewModel> GetMany(object where, Needletail.DataAccess.Engines.FilterType filterType, object orderBy, int? topN)
        {
            return this.dataSource.GetMany(where: where, filterType: filterType, orderBy: orderBy, topN: topN);
        }

        public IEnumerable<CourseViewModel> GetMany(object where, object orderBy, Needletail.DataAccess.Engines.FilterType filterType, int page, int pageSize)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy, filterType: filterType, page: page, pageSize: pageSize);
        }

        public IEnumerable<CourseViewModel> GetMany(string where, string orderBy, Dictionary<string, object> args, int page, int pageSize)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy, args: args, page: page, pageSize: pageSize);
        }

        public IEnumerable<CourseViewModel> GetMany(string where, string orderBy, Dictionary<string, object> args, int? topN)
        {
        ...
        public CourseViewModel GetSingle(object where)
        {
            return this.dataSource.GetSingle(where: where);
        }

        public CourseViewModel GetSingle(object where, Needletail.DataAccess.Engines.FilterType filterType)
        {
            return this.dataSource.GetSingle(where: where, filterType: filterType);
        }

        public CourseViewModel GetSingle(string where, Dictionary<string, object> args)
        {
            return this.dataSource.GetSingle(where: where, args: args);
        }

        public Guid Insert(CourseViewModel newItem)
        {
